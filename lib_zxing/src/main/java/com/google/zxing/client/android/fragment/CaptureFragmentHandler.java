...
public final class CaptureFragmentHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        if (message.what == R.id.restart_preview) {
            ...
            if (bundle != null) {
                byte[] compressedBitmap = bundle.getByteArray(DecodeFragmentThread.BARCODE_BITMAP);
                if (compressedBitmap != null) {
                    barcode = BitmapFactory.decodeByteArray(compressedBitmap, 0, compressedBitmap.length, null);
                    // Mutable copy:
                    barcode = barcode.copy(Bitmap.Config.ARGB_8888, true);
                }
                scaleFactor = bundle.getFloat(DecodeFragmentThread.BARCODE_SCALED_FACTOR);
            }
...
//            fragment.finish();
            ...
            // TODO: 2020/7/2
            ResolveInfo resolveInfo = fragment.getActivity().getPackageManager().resolveActivity(intent, PackageManager.MATCH_DEFAULT_ONLY);
